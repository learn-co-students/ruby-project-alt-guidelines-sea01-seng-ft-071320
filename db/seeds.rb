...
pullup = Exercise.create(name: "Push Up", description: "The pull-up is a closed-chain movement where the body is suspended by the hands and pulls up.", body_part: "Chest", sets: 10, reps: 10)
pushup = Exercise.create(name: "Push Up", description: "Push your body up and away from the ground", body_part: "Chest", sets: 10, reps: 10)
pushup = Exercise.create(name: "Push Up", description: "Push your body up and away from the ground", body_part: "Chest", sets: 10, reps: 10)
pushup = Exercise.create(name: "Push Up", description: "Push your body up and away from the ground", body_part: "Chest", sets: 10, reps: 10)
pushup = Exercise.create(name: "Push Up", description: "Push your body up and away from the ground", body_part: "Chest", sets: 10, reps: 10)
